...
namespace NodeNetwork.ViewModels
{
    ...
    public class Serializeable : System.Attribute
    {
    }
    /// <summary>
    ...
    public class NodeViewModel : ReactiveObject
    {
        ...
        {
            get => _is_high_light;
            set => this.RaiseAndSetIfChanged(ref _is_high_light, value);
        }
        double _processing_time;
        
        public double ProcessingTime
        {
            get => _processing_time;
            set => this.RaiseAndSetIfChanged(ref _processing_time, value);
        }
        ...
        {
            get => _error_message;
            set => this.RaiseAndSetIfChanged(ref _error_message, value);
        }
        ...
        public void BaseRun(object context)
        {
            if (CheckUpdated())
            {
        ...
        public void UpdateConnections(object context)
        {
            foreach(var item in Outputs.Items)
            {
                ...
                foreach(var item2 in item.Connections.Items)
                {
                    item2.Input.IsUpdated = item.IsUpdated ;
                    //item2.Input.Value
        ...
        public string TestType { get; set; } = "Test Type";
        #endregion
