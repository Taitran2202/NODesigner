...
namespace NodeNetwork.ViewModels
{
    ...
    public abstract class Endpoint : ReactiveObject
    {
        ...
        #endregion
        #region NameConnection
        /// <summary>
        /// The connection name of this endpoint.
        /// In the default view, this string is displayed in the node next to the port.
        /// </summary>
        public string NameConnection
        {
            get => _name_connection;
            set => this.RaiseAndSetIfChanged(ref _name_connection, value);
        }
        private string _name_connection = "";
        #endregion
        #region Name
        /// <summary>
