...
namespace NodeNetwork.ViewModels
{
    ...
    public class ConnectionViewModel : ReactiveObject
    {
        ...
        public ConnectionViewModel(NetworkViewModel parent, NodeInputViewModel input, NodeOutputViewModel output)
        {
            ...
            this.WhenAnyValue(v => v.Input.Parent.IsSelected, v => v.Output.Parent.IsSelected, (x1, x2) => x1 | x2)
                .Subscribe(x => { IsNodeSelected = x; Input.Port.IsHighlighted = x;Output.Port.IsHighlighted = x; });
        }
    }
}
