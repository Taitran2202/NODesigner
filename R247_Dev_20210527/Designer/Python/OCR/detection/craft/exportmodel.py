...
class UNETOCR:
    ...
    def buildModel(self):
        ...
        pretrain_path = 'weights/mobilenetv2'
        ...
        model = Model(img_input,(float_output),name='unet_mobilenet')
...
model_proto, external_tensor_storage = tf2onnx.convert.from_keras(model.model,
            ...
            target=None, large_model=False, output_path=os.path.join("temp",'model.onnx'))
