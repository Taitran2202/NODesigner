...
class ClassifierOCRMedium(Model):
    ...
    def build(self):
        ...
        pretrain_model.get_layer('dense').trainable=True
        ...
        self.model = Model(inputs=img_input, outputs=dummy_model(img_input), name='OCRClassifyMedium')
        return self.model