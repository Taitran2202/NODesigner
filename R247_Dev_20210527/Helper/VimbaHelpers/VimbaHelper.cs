...
namespace NOVisionDesigner.Helper
{
        ...
        public class VimbaHelper
        {
            ...
            /// </summary>
            public bool m_Acquiring = false;

            /// <summary>
            /// Frames received handler
            /// </summary>
            public FrameReceivedHandler m_FrameReceivedHandler = null;
        ...
        public void CloseCamera()
            ...
            private void OnFrameReceived(Frame frame)
            {
                ...
                HImage image = ConvertToHimage(frame);
        ...
        public HImage ConvertToHimage(AVT.VmbAPINET.Frame a)
        {
            if (a == null)
            {
                return null;
            ...
            byte[] e = new byte[a.Buffer.Length];
            a.Buffer.CopyTo(e, 0);
            GCHandle pinnedArray = GCHandle.Alloc(e, GCHandleType.Pinned);
            IntPtr pointer = pinnedArray.AddrOfPinnedObject();
            if (a.PixelFormat == VmbPixelFormatType.VmbPixelFormatBayerRG8)
            {
                image.GenImage1("byte", (int)a.Width, (int)a.Height, pointer);
                //image.GenImageInterleaved(pointer, "rgb", (int)a.Width, (int)a.Height, 0, "byte", 0, 0, 0, 0, 8, 0);
                image = image.CfaToRgb("bayer_rg", "bilinear_enhanced");
            }
            if (a.PixelFormat == VmbPixelFormatType.VmbPixelFormatRgb8)
            {
                //image2.GenImage1("byte", (int)a.Width, (int)a.Height, pointer);
                image.GenImageInterleaved(pointer, "rgb", (int)a.Width, (int)a.Height, 0, "byte", 0, 0, 0, 0, 8, 0);
                //image2 = image2.CfaToRgb("bayer_rg", "bilinear_enhanced");               

            }
            if (a.PixelFormat == VmbPixelFormatType.VmbPixelFormatMono8)
            {
                image.GenImage1("byte", (int)a.Width, (int)a.Height, pointer);
                //image.GenImageInterleaved(pointer, "rgb", (int)a.Width, (int)a.Height, 0, "byte", 0, 0, 0, 0, 8, 0);
                ////image2 = image2.CfaToRgb("bayer_rg", "bilinear_enhanced");
